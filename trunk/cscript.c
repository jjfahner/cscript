...
static const char *const yyRuleName[] = {
 ...
 /*  66 */ "list_start ::= LBRACKET",
 /*  67 */ "list_end ::= RBRACKET",
 /*  68 */ "list_entry ::= expression",
 /*  69 */ "list_content ::= list_entry",
 /*  70 */ "list_content ::= list_content COMMA list_entry",
 /*  71 */ "function_call ::= function_call_start LPAREN argument_list RPAREN function_call_end",
 ...
 /*  87 */ "function_declaration ::= function_name LPAREN parameter_list parameters_done RPAREN function_body",
 ...
 /* 100 */ "function_block_start ::= LBRACE",
 /* 101 */ "function_block_end ::= RBRACE",
 ...
 /* 122 */ "if_cond ::= LPAREN expression RPAREN",
 /* 123 */ "if_else ::=",
 ...
 /* 129 */ "while_condition ::= LPAREN expression RPAREN",
 /* 130 */ "while_content ::= statement",
 /* 131 */ "foreach_statement ::= foreach_init LPAREN for_lvalue IN for_expression RPAREN statement foreach_end",
