...
struct reset_exception : public std::runtime_error
{
  // TODO a shame this isn't a script_exception, but
  // there is no Ast instance available...
  reset_exception() : std::runtime_error("reset") {}
