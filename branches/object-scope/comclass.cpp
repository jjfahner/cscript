...
ComObject::Find(Value const& name, RValue*& ptr) const
{
  ...
  {
    ptr = new ROVariable(const_cast<ComObject*>(this), 
      new ComMemberFunction(properName, dispid, this));
  }
  else
  {
    ...
    {
      ptr = new RWComVariable(const_cast<ComObject*>(this), 
        properName, dispid, this);
    }
    else
    {
      ptr = new ROComVariable(const_cast<ComObject*>(this), 
        properName, dispid, this);
    }
  }
...
ROComVariable::ROComVariable(Object* owner, String name, DISPID dispid, ComObject const* inst) :
RValue    (owner),
m_name    (name),
m_dispid  (dispid),
m_inst    (inst)
...
RWComVariable::RWComVariable(Object* owner, String name, DISPID dispid, ComObject const* inst) :
LValue    (owner),
m_name    (name),
m_dispid  (dispid),
m_inst    (inst)
