...
public:
  ...
  // Construction
  //
  RValue(Object* owner) : m_owner (owner)
  {
  }
...
class ROVariable : public RValue
{
  Value m_value;

public:

  ROVariable(Object* owner, Value const& value) :
  RValue  (owner),
  m_value (value)
  {
  }
...
class RWVariable : public LValue
{
  Value m_value;

public:

  RWVariable(Object* owner, Value const& value) :
  LValue  (owner),
  m_value (value)
  {
  }
...
public:
  ...
  Temporary(Object* owner, Value const& value) :
  RValue  (owner),
  m_value (value)
  {
  }
